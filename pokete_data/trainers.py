trainers = {
    ...
    "playmap_2": [{
        ...
        "args": ("Wanderer Murrad", "He",
                [" < Isn't that a great day?", " < I traveled here from a far country", " < Do you want to fight against my rare Pokete?"],
    ...
    "playmap_5": [{
        ...
        "args": ("Caveman Marc", "He",
                [" < Oh!", " < I've not seen anyone down here for while", " < Can I show you my rare Pokete, that can only be found in this cave?"],
    ...
    "playmap_12": [{
        ...
        "args": ("Brother Justin", "He",
                [" < Hey, my brother and me want to fight!"],
                [" < Haha, you're bad!"],
                [" < I see you don't have a living Pokete"],
                [" < Damn!"], 26, 10)
        }, {
    ...
    "playmap_19": [{
        ...
        "args": ("Brian", "He",
                ...
                [" < Oooooh!", " < You're a fucking loooser!"],
                [" < I see you don't have a living Pokete"],
    ...
    "playmap_21": [{
        ...
        "args": ("Rock hard Rick", "He",
                [" < Hello trainer!", " < Welcome to Rock-ville, the highest place in the Pokete world and the home of all stone Poketes.", " < When leaving this town through the 'Cave of doom' you have to fight against the best trainers of this town.", " < But first, you have to fight me!"],
