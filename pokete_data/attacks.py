attacks = {
    ...
    "storm_gust": {
        ...
        "miss_chance": 0,
        "min_lvl": 0,
        "desc": "Casts a vicious and violent storm full of rain and hail that hits the enemy in its weakest spots "
    ...
    "eye_pick": {
        ...
        "miss_chance": 0.6,
        "min_lvl": 0,
        "desc": "Pecks out one of the enemy's eyes.",
        "types": ["flying", "bird"],
        "effect": None,
        "is_generic": True,
        "ap": 10,
    ...
    "heart_touch": {
        ...
        "miss_chance": 0,
        "min_lvl": 20,
        "desc": "Touches the enemy's heart with cold ghost claws.",
        "types": ["undead"],
        "effect": None,
        "is_generic": True,
        "ap": 10,
