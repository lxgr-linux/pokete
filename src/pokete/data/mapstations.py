from pokete.classes.asset_service.resources import DecorationDict, StationDict
...
├───
 # #""",
    ...
    "playmap_51": {
        "gen": {
            "additionals": [],
            "desc": "Some small patches of grass surrounded by forrest, near "
            "Nice Town.",
            "a_next": "playmap_57",
            "w_next": "cave_1",
            "text": r"""└─┐
