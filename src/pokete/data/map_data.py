...
())())
 ||||""",
            ...
            "pokecenter": {"x": 20, "y": 0, "txt": CENTER},
            "house1": {"x": 2, "y": 0, "txt": HOUSE1},
            "house2": {"x": 5, "y": 17, "txt": HOUSE1},
            "house3": {"x": 53, "y": 17, "txt": HOUSE1},
            "house4": {"x": 61, "y": 0, "txt": HOUSE1},
            "fence": {
                "x": 0,
                "y": 0,
                "txt": """                                                                                         #
...
())())
 ||||""",
            ...
            "pokecenter": {"x": 20, "y": 2, "txt": CENTER},
            "shop": {"x": 56, "y": 2, "txt": SHOP},
            "house2": {"x": 18, "y": 11, "txt": HOUSE1},
            "house3": {"x": 18, "y": 17, "txt": HOUSE1},
            "house4": {"x": 58, "y": 9, "txt": HOUSE1},
            "fence1": {
                "x": 3,
                "y": 0,
                "txt": """                                   #
...
(())
 |||""",
            ...
            "house1": {"x": 40, "y": 0, "txt": HOUSE1},
            "house2": {"x": 46, "y": 10, "txt": HOUSE1},
        },
        "soft_obs": {
            "meadow1": {
                "x": 9,
...
""",
            ...
            "pokecenter": {"x": 9, "y": 25, "txt": CENTER},
            "shop": {"x": 47, "y": 25, "txt": SHOP},
            "house1": {"x": 47, "y": 4, "txt": HOUSE1},
            "house2": {"x": 47, "y": 10, "txt": HOUSE1},
            "house3": {"x": 47, "y": 16, "txt": HOUSE1},
            "house4": {"x": 10, "y": 4, "txt": HOUSE1},
            "house5": {"x": 10, "y": 10, "txt": HOUSE1},
            "house6": {"x": 10, "y": 16, "txt": HOUSE1},
        },
        "soft_obs": {
            "meadow_1": {
                "x": 29,
...
(((()(())))
 ||||| |||""",
            ...
            "pokecenter": {"x": 5, "y": 3, "txt": CENTER},
            "shop": {"x": 29, "y": 3, "txt": SHOP},
            "hotel": {
                "x": 43,
                "y": 18,
                "txt": r"""   ..___________
...
|____|  |____|____|""",
            ...
            "house1": {"x": 21, "y": 20, "txt": HOUSE1},
            "house2": {"x": 69, "y": 20, "txt": HOUSE1},
            "house3": {"x": 46, "y": 3, "txt": HOUSE1},
            "house4": {
                "x": 84,
                "y": 20,
...
|___| |_______|_######""",
            ...
            "house5": {"x": 130, "y": 6, "txt": HOUSE1},
            "house6": {"x": 72, "y": 2, "txt": HOUSE1},
        },
        "soft_obs": {
            "water1": {
                "x": 65,
...
""",
            ...
            "pokecenter": {"x": 8, "y": 3, "txt": CENTER},
            "shop": {"x": 25, "y": 3, "txt": SHOP},
        },
        "soft_obs": {},
        "dors": {
            "dor_playmap_28_1": {
...
""",
            ...
            "pokecenter": {"x": 39, "y": 48, "txt": CENTER},
            "shop": {"x": 117, "y": 60, "txt": SHOP},
            "tree_group_1": {
                "x": 135,
                "y": 61,
                "txt": """ ()))
   ...
   ;;;""",
        ...
        "dors": {
            ...
            "dor_playmap_52_1": {
                "x": 197,
                "y": 36,
                "args": {"map": "playmap_52", "x": 1, "y": 31},
            },
            "dor_playmap_52_2": {
                "x": 197,
                "y": 37,
                "args": {"map": "playmap_52", "x": 1, "y": 32},
            },
        },
        "special_dors": {
            "dor": {
  ...
  ......
    ...""",
        ...
        "dors": {
            ...
            #    "y": 32,
            #
            #    "args": {"map": "playmap_52", "x": 199, "y": 32},
            # },
            "dor_playmap_39_1": {
                "x": 0,
                "y": 31,
                "args": {"map": "playmap_39", "x": 196, "y": 36},
            },
            "dor_playmap_39_2": {
                "x": 0,
                "y": 32,
                "args": {"map": "playmap_39", "x": 196, "y": 37},
            },
            "dor_playmap_52_5": {
                "x": 94,
                "y": 33,
                "args": {"map": "playmap_56", "x": 14, "y": 0},
            },
        },
        "balls": {
            "ball_1": {"x": 2, "y": 44},
...
|________|___  ___|""",
        ...
        "balls": {"ball_1": {"x": 12, "y": 4}, "ball_2": {"x": 21, "y": 7}},
    },
    "playmap_55": {
        "hard_obs": {
            "inner_walls": {
...
|                                                |                |
|                                |               |                |
|____  ____________________  ____|_________  ____|_  _____________|
|                                                                 |
|                                                                 |
...
|______________________________/   \______________________________|""",
        ...
        "dors": {
            "dor_playmap_55_1": {
                "x": 34,
                "y": 0,
                "args": {"map": "playmap_52", "x": 107, "y": 42},
            },
            "dor_playmap_55_2": {
                "x": 35,
                "y": 0,
                "args": {"map": "playmap_52", "x": 108, "y": 42},
            },
            "dor_playmap_54_3": {
                "x": 36,
                "y": 0,
                "args": {"map": "playmap_52", "x": 18, "y": 42},
            },
            "dor_playmap_54_4": {
                "x": 94,
                "y": 33,
...
|________|___  ___|""",
    ...
    "playmap_57": {
        "hard_obs": {
            "house_top_left": {"x": 10, "y": 1, "txt": HOUSE1},
            "house_top_center": {"x": 40, "y": 1, "txt": HOUSE1},
            "house_top_right": {"x": 70, "y": 1, "txt": HOUSE1},
            "house_bottom_left": {"x": 10, "y": 17, "txt": HOUSE1},
            "house_bottom_center": {"x": 40, "y": 17, "txt": HOUSE1},
            "house_bottom_right": {"x": 70, "y": 17, "txt": HOUSE1},
            "fence": {
                "x": 0,
                "y": 0,
                "txt": """                                                               #
