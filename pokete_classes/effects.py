 ...
 This is reverted randomly."
    ...
    def __init__(self, obj=None):
        super(EffectBurning, self).__init__(
            "poisoned", 4, 2, "(Poi)", Color.purple, obj
        )
...
class EffectConfusion(Effect):
    ...
    def __init__(self, obj=None):
        super().__init__(
            "confused", 3, 2, "(Con)", Color.lightblue, obj, exclude=["undead"]
        )
...
This is reverted randomly."
    ...
    def __init__(self, obj=None):
        super().__init__(
            "frozen", 3, 3, "(Fro)", Color.cyan, obj, exclude=["ice", "fire"]
        )
